    ...
    <div class="container mt-4">
        ...
        <form method="POST" action="{{ route('posts.store') }}">
            ...
            <div class="mb-3">
                ...
                <input value="{{ today()->format('Y-m-d') }}" type="date" class="form-control" name="tanggal" required>
            </div>

            <div class="mb-3">
                <label for="title" class="form-label">Nomor Antrian</label>
                <input value="{{ old('antrian') }}" type="text" class="form-control" name="no_antrian"
                    required>
            </div>

            <div class="mb-3">
                <label for="nama" class="form-label">Nama Pasien</label>
                <input value="{{ old('nama_pasien') }}" type="text" class="form-control" name="nama_pasien"
            ...
            <select class="form-select mb-3" id="poli_id" name="poli_id">
                <option selected>Pilih Jenis Poli</option>
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('alamat') }}" type="text" class="form-control" name="alamat_pasien"
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('no_telp') }}" type="text" class="form-control" name="no_telp_pasien"
            ...
            <button type="submit" class="btn btn-primary">Save pasien</button>
